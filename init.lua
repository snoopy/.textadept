...
snippets.cpp.dc = 'dynamic_cast<$1>($0)'
snippets.cpp.enm = 'enum class $1 ${2:: std::size_t} {\n\t$0\n};'
...
snippets.cpp.mn = 'main(int argc, char** argv) {\n\t$0\n\treturn 0;\n}'
snippets.cpp.ms = 'std::make_shared<$1>($0)'
snippets.cpp.mu = 'std::make_unique<$1>($0)'
snippets.cpp.nsp = 'namespace $1 {\n\t$0\n} // namespace $1'
...
snippets.cpp.up = 'std::unique_ptr<$1>'
snippets.cpp.us = '#include <$0>'
snippets.cpp.usc = '#include <cstddef>\n#include <cstdint>\n#include <fstream>\n#include <iostream>\n#include <string>\n#include <map>\n#include <vector>'
snippets.cpp.usl = '#include "$0"'
