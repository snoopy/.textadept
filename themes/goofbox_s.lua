...
styles[view.STYLE_DEFAULT] = {
  font = font, size = size, fore = gray8, back = bg0_s
}
styles[view.STYLE_LINENUMBER] = {fore = bg2, back = bg0_s}
...
styles[lexer.OPERATOR] = {fore = gray7}
...
-- Indicators.
view.indic_fore[ui.find.INDIC_FIND] = 0x757575
view.indic_alpha[ui.find.INDIC_FIND] = 32
view.indic_outline_alpha[ui.find.INDIC_FIND] = 128

view.indic_fore[textadept.editing.INDIC_HIGHLIGHT] = 0x757575
