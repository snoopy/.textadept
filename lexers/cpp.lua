...
-- Types.
local stl_type = lex:tag(lexer.DEFAULT, 'std::') * lex:tag(lexer.TYPE .. '.stl', lex:word_match(lexer.TYPE .. '.stl'))
...
lex:add_rule('predefined_macros', lex:tag(lexer.VARIABLE_BUILTIN .. '.macros', lex:word_match(lexer.VARIABLE_BUILTIN .. '.macros')))
...
lex:set_word_list(lexer.VARIABLE_BUILTIN .. '.macros', {
